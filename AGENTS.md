...
## Attribution — do NOT add AI/Codex attribution anywhere
- Never append `Co-Authored-By: Codex ...` (or any AI co-author) to commit messages.
- Never add "Generated with Codex", "Created by Codex", or similar lines to commits,
